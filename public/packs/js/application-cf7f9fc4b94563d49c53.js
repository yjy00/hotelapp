...
Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(function () {
  Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('.chat-form').on('submit', function (e) {
    e.preventDefault();
    var chat = Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('.chat-message-form').val();
    _rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"].ajax({
      type: 'POST',
      url: '/chats',
      data: {
        chat: {
      ...
      var html = Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('<li class="message">').append(data.content);
      Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('.chats').append(html);
      Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('.chat-message-form').val('');
    }).fail(function () {
      alert('error');
    });
  });
...
/******/ });
//# sourceMappingURL=application-cf7f9fc4b94563d49c53.js.map