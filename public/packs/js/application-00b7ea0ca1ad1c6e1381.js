...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatChannel", {
  ...
  received: function received(data) {
    var html = "<p>".concat(data.from.attributes.name, "</p>\n       <p>").concat(data.name, "</p>\n       <p>").concat(data.content.message, "</p>");
    var chats = document.getElementById('chats');
    chats.insertAdjacentHTML('afterbegin', html);
    var newChat = document.getElementById('chat_message');
    var newChatBy = document.getElementById('chat_by');
    var newChatId = document.getElementById('chat_from_id');
    newChat.value = '';
    newChatBy.value = '';
    newChatId.value = '1';
  }
...
__webpack_require__(/*! ./chat */ "./app/javascript/packs/chat.js");
...
/******/ });
//# sourceMappingURL=application-00b7ea0ca1ad1c6e1381.js.map