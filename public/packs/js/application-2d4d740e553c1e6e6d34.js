...
/* WEBPACK VAR INJECTION */(function($) {// import { $ } from "@rails/ujs";
$(function () {
  $('.chat-form').on('submit', function (e) {
    e.preventDefault();
    var chat = $('.chat-message-form').val();
    $.ajax({
      type: 'POST',
      url: '/chats',
      data: {
      ...
      console.log('a'); //   let html = $('<p class="message">').append(data.content);
      //   $('.chats').append(html);
...
/******/ });
//# sourceMappingURL=application-2d4d740e553c1e6e6d34.js.map