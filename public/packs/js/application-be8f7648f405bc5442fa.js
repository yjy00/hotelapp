...
Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(function () {
  Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])('.chat-form').on('submit', function (e) {
    ...
    _rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"].ajax({//   type: 'POST',
      //   url: '/chats',
      //   data: {
      //     chat: {
      //       content: chat
      ...
      // .done(function(data) {
      //   console.log('a')
      // let html = $('<li class="message">').append(data.content);
      // $('.chats').append(html);
...
/******/ });
//# sourceMappingURL=application-be8f7648f405bc5442fa.js.map