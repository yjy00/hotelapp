...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatChannel", {
  ...
  received: function received(data) {
    var html = " <p>".concat(data.content.from_id.name, "</p>\n          <p>").concat(data.name, "</p>\n          <p>").concat(data.content.message, "</p> ");
    var messages = document.getElementById('chats');
    var newChatFormId = document.getElementById('chat_form_id');
...
/******/ });
//# sourceMappingURL=application-30352d817dd546532ff9.js.map